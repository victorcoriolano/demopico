              ...
              child: Consumer<SpotProvider>(
                builder: (context, spotProvider, child) {
                  ...
                  if (spotProvider.error != null) {
                    return Center(
                      child: Text(spotProvider.error!),
                    );
                  }
                  if (spotProvider.pico == null) {
                    return Center(
                      child: Text("Não foi possível verificar spot"),
                    );
                  }
                  return Column(
                    children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ObstacleWidget(
                                          obstacles: spotProvider
                                              .pico!.obstaculos.obstacles),
                                      EvaluateWidget(
                                          rate:
                                              spotProvider.pico!.rating.average,
                                          numberReviews: spotProvider
                                              .pico!.rating.numberOfReviews),
                                    ],
                                  ),
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      CustomElevatedButton(
                                        onPressed: () {
                                          Get.to(() => CommentPage(
                                              picoId: widget.idPico));
                                        },
                                        textButton: "ABRIR DISCUSSÃO",
                                      ),
                                      CustomOutlineButton(
                                        onPressed: () =>
                                            ModalHelper.openRateSpotModal(
                                                context, spotProvider.pico!),
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        width: 0,
                                        color:
                                            const Color.fromARGB(0, 70, 70, 70),
                                      ),
                                      color: kGrey100,
                                    ),
                                    child: Column(
                                      children: [
                                        for (final entry in spotProvider.pico!
                                            .atributosVO.attributes.entries)
                                          Center(
                                            child: Column(
                                              crossAxisAlignment:
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  spotProvider.pico!.atributosVO
                                                      .obterDescricao(entry.key,
                                                          entry.value),
                                                  style: TextStyle(
                                                      color: kMediumGrey),
                                                ),
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                            ...
                                            onPressed: () {
                                              if (user == null) {
                                                Get.snackbar("Erro",
                                                    "Você precisa estar logado para reportar um spot");
                                                return;
                                              }
                                              ModalHelper.openReportSpotModal(
                                                  context,
                                                  user?.id,
                                                  widget.idPico,
                                                  TypePublication.pico);
                                            },
