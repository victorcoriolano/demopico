...
Widget build(BuildContext context) {
  ...
  final spotProvider = Provider.of<SpotControllerProvider>(context, listen: false);
  ...
  Pico? picoPesquisado = spotProvider.spots.firstWhere((pico) => name == pico.picoName);
  ...
  ScaffoldMessenger.of(context).showSnackBar(
    const SnackBar(content: Text("Pico não encontrado"),
    ),
  );
    }
  ...
  print("Erro fudidassa");
      ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text("Erro ao procurar pico! Deseja procurar na lista de picos?"),
  ...
  return AppBar(
    ...
    title: Row(
      ...
      children: [
          ...
          child: SizedBox(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                contentPadding: const EdgeInsets.symmetric(vertical: 10), // Centraliza o conteúdo verticalmente
        ...
        const SizedBox(width: 10), // Espaçamento entre a barra de busca e os ícones
