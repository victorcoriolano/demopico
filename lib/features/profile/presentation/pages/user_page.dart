...
class _UserPageState extends State<UserPage> {
  ...
  Widget build(BuildContext context) {
    return Consumer2<EditProfileProvider, DatabaseProvider>(
                    ...
                    children: [
                      ...
                      SizedBox(
                        child: GestureDetector(
                          onTap: () async {
                            await provider
                                .selecionarImag(); // Aguarda o upload ser concluído

                            if (provider.imgUser.isNotEmpty) {
                              provider2.updateUserImg(provider
                                  .imgUser); // Agora você tem a URL correta
                              print("Atualizado com sucesso!");
                              setState(() {
                                user?.pictureUrl = provider.imgUser;
                              });
                            } else {
                              print("Erro: imgUser está vazio ou nulo!");
                            }
                          },
                          child: user?.pictureUrl == ''
                              ? IconButton.filled(
                                  onPressed: null,
