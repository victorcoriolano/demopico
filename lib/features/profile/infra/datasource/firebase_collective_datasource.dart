...
class FirebaseCollectiveDatasource implements IColetivoDatasource {
  final ICrudDataSource _crudBoilerplate;
    static FirebaseCollectiveDatasource? _instance;

    FirebaseCollectiveDatasource({ required ICrudDataSource crudDatasoure}):_crudBoilerplate = crudDatasoure;
  ...
  Future<void> updateColetivo(FirebaseDTO coletivo) async {
    return await _crudBoilerplate.update(coletivo);
  }
