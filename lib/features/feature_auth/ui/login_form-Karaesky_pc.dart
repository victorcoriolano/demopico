        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton(onPressed: () {}, child: const Text("Esqueceu senha", style: TextStyle(color: Color.fromARGB(255, 189, 198, 214)),)),
              
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  
                  IconButton(onPressed: () {}, icon: const Icon(Icons.adb), color: Colors.white,),
                  IconButton(onPressed: () {}, icon: const Icon(Icons.account_circle),  color: Colors.white,),
                  IconButton(onPressed: () {}, icon: const Icon(Icons.email_rounded), color: Colors.white,),
                ],
              ),
