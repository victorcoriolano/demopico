...
class HubRepositoryImpl implements IHubRepository {
  HubRepositoryImpl? _hubRepository;
  final Firestore firestore;

  HubRepositoryImpl({required this.firestore});

  HubRepositoryImpl get getInstance {
    _hubRepository ??= HubRepositoryImpl(firestore: firestore);
